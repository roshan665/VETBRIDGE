...
const placeholders: Record<string, PlaceholderConfig> = {
  ...
  help: { title: 'Help and support', description: 'Find guidance for monitoring livestock health and using VETBRIDGE effectively.', icon: ClipboardCheck, plannedFeatures: ['Role-based user guides', 'Disease response playbooks', 'Frequently asked questions', 'Contact support request'], dataSources: ['GET /resources', 'POST /support/tickets'] },
}
